...
def recommend_fields(intermediate_marks, percentage, field_of_interest):
    ...
    # Biology
    if intermediate_marks >= 935 and percentage >= 85 and field_of_interest == 'biology':
        recommended_fields.append(' Medicine(MBBS)')
        recommended_fields.append(' Dentistry(BDS)')
    if intermediate_marks >= 825 and percentage >= 75 and field_of_interest == 'biology':
    ...
    if intermediate_marks >= 660 and percentage >= 60 and field_of_interest == 'biology':
